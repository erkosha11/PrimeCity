  ...
  return (
    <div className={s.text}>
      <div className={s.card}>
        ...
        <h1>Монтаж окон</h1>
        <p>Монтаж окон и установка межкомнатных и входных дверей.</p>
      </div>

      <div className={s.card}>
        <img src={OtoplenieImg} alt="Установка систем отопления" />
        <h1>Cистем отопления</h1>
        <p>Монтаж радиаторов и котлов и установка теплых полов.</p>
      </div>
      ...
      <div className={s.card}>
        ...
        <p>
          Монтаж кухонных шкафов и столешниц и установка бытовой техники
          (духовки, плиты, вытяжки и т.д.).
        </p>
      </div>
      ...
      <div className={s.card}>
        ...
        <p>
          Сборка и установка шкафов, полок, кроватей и других предметов мебели.
        </p>
      </div>
      ...
      <div className={s.card}>
        ...
        <p>Монтаж ламината, паркета, ковровых покрытий и укладка плитки.</p>
      </div>

      <div className={s.card}>
        <img src={ZaborImg} alt="Установка ограждений и ворот" />
        <h1>Установка ограждений и ворот</h1>
        <p>Монтаж заборов, калиток и ворот.</p>
      </div>
    </div>
  );
};
